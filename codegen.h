...
class CodeGenerator {
    private:
        ...
        BeginFunc *curFxn; // start fxn for current fxn
        int insideFn;
        Hashtable<int> *labels; // label position table
    ...
    public:
        ...
        void Genlabels();
        void GenSucc();
        void LiveVarAnalysis(int start, int end);
        void LivenessAnalysis();
        InterferenceGraph *BuildGraph(int start, int end);
        void RegAllocation(InterferenceGraph *graph, int start, int end);
        void GraphColoring();
        void GenRegMap();
};
