...
class Instruction {
    ...
    public:
        ...
        virtual Location *Getlhs() const  { return NULL; }
        virtual Location *Getrhs1() const  { return NULL; }
        virtual Location *Getrhs2() const  { return NULL; }
};
...
class LoadConstant: public Instruction {
    ...
    virtual Location *Getlhs() const { return dst; }
};
...
class Assign: public Instruction {
    ...
    void EmitSpecific(Mips *mips);
    virtual Location *Getlhs() const { return dst; }
    virtual Location *Getrhs1() const  { return src; }
};
...
class Load: public Instruction {
    ...
    void EmitSpecific(Mips *mips);
    Location *Getlhs() const { return dst; }
    virtual Location *Getrhs1() const  { return src; }
};
...
class Store: public Instruction {
    ...
    void EmitSpecific(Mips *mips);
    virtual Location *Getrhs1() const  { return src; }
    virtual Location *Getrhs2() const  { return dst; }
    virtual Location *Getlhs() const  { return dst; }
};
...
class BinaryOp: public Instruction {
    ...
    public:
        ...
        void EmitSpecific(Mips *mips);
        Location *Getlhs() const { return dst; }
        virtual Location *Getrhs1() const  { return op1; }
        virtual Location *Getrhs2() const  { return op2; }
};
...
class IfZ: public Instruction {
    ...
    virtual Location *Getrhs1() const  { return test; }
};
...
class Return: public Instruction {
    ...
    Return(Location *val);
    void EmitSpecific(Mips *mips);
    virtual Location *Getrhs1() const  { return val; }
};
...
class PushParam: public Instruction {
    ...
    void EmitSpecific(Mips *mips);
    virtual Location *Getrhs1() const  { return param; }
}; 
